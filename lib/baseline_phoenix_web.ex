defmodule BaselinePhoenixWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: BaselinePhoenixWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {BaselinePhoenixWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: BaselinePhoenixWeb.Router,
        statics: BaselinePhoenixWeb.static_paths()
    end
  end
